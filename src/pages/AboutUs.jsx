...
const AboutUs = () => {
  return (
    <div className="w-11/12 py-12  mx-auto">
      ...
      <div className="flex flex-col md:flex-row-reverse items-center bg-base-100 shadow-xl rounded-xl overflow-hidden">
        {/* Image */}
        ...
        <div className="w-full md:w-1/2 p-6 text-center md:text-left">
          ...
          <div className="flex justify-center md:justify-start gap-4 mt-5 text-xl text-primary">
