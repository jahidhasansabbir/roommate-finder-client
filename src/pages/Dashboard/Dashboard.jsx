...
const Dashboard = () => {
  return (
    <div className="drawer max-w-[1440px] mx-auto lg:drawer-open bg-base-100 text-white">
      <input id="dashboard-drawer" type="checkbox" className="drawer-toggle" />

      {/* ✅ Main Content */}
      <div className="drawer-content flex flex-col">
        {/* ✅ Top navbar (Mobile) */}
        <div className="w-full shadow-md  text-white lg:hidden z-10">
        ...
        {/* ✅ Page Content */}
        <div className=" min-h-screen md:my-6 text-white">
          <Outlet />
        </div>
      </div>
      ...
      <div className="drawer-side z-20">
        ...
        <aside className="menu p-4 w-64 min-h-full  border-r border-gray-700 text-white bg-gray-700 space-y-1">
          ...
          <li>
            <NavLink
              to="/dashboard/add-to-find-roommate"
              className="flex items-center gap-3 hover:bg-gray-700 rounded-lg px-3 py-2"
            >
